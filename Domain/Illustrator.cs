// <copyright file="Illustrator.cs" company="Филипченко Марина Алексеевна">
...
namespace Domain
{
    ...
    /// Редактор.
    /// </summary>
    public sealed class Illustrator : PersonRole<Illustrator>
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="Illustrator"/>.
        /// </summary>
        /// <param name="person"> Персона. </param>
        /// <exception cref="ArgumentNullException">
        /// Если Полное имя <see langword="null"/>.
        /// </exception>
        public Illustrator(Person person)
            : base(person)
        {
        }
