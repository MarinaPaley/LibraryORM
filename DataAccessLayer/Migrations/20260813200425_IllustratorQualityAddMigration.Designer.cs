...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260813200425_IllustratorQualityAddMigration")]
    partial class IllustratorQualityAddMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Illustrator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Illustrators", null, t =>
                        {
                            t.HasComment("Художники");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Book", b =>
                {
                    ...
                    b.HasOne("Domain.Illustrator", "Illustrator")
                        .WithMany("Books")
                    ...
                    b.OwnsOne("Domain.Title", "OriginName", b1 =>
                        {
                            ...
                            b1.Property<string>("Value")
                                ...
                                .HasComment("Оригинальное название категории");
            ...
            modelBuilder.Entity("Domain.Illustrator", b =>
                {
                    b.HasOne("Domain.Person", "Person")
                        .WithOne("Illustrator")
                        .HasForeignKey("Domain.Illustrator", "PersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.OwnsOne("Domain.Title", "OriginName", b1 =>
                        {
                            ...
                            b1.Property<string>("Value")
                                ...
                                .HasColumnType("character varying(200)")
                                .HasColumnName("OriginTitle")
                                .HasComment("Оригинальное название тега");
